...
namespace Workshopper.Filesystem
{
    internal static class KeyValuesUtils
    {
        public static List<string> ReadFileToList(string filePath)
        {
            ...
            {
                Utils.LogAction(string.Format("Unable to read file '{0}' for KeyValues!", filePath));
                return null;
            }
        }
        ...
        public static List<string> ReadStreamToList(string stream)
        {
            ...
            {
                Utils.LogAction("Unable to read stream for KeyValues!");
                return null;
            }
        }
        ...
        public static string GetUrlStream(string url)
        {
            ...
            {
                Utils.LogAction("Unable to read url for KeyValues!");
                return null;
            }
        }
    }
